...
\href{https://julialang.org}{Julia} в виде локального модуля \texttt{A1} и расположен в GitHub репозитории \href{https://github.com/paveloom-p/P12}{paveloom-p/P12} в папке \href{https://github.com/paveloom-p/P12/tree/master/A1}{A1}. Далее приводятся только сниппеты кода.
